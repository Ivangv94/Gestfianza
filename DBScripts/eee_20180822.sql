...
alter table "EXPEDIENTE"."PREVIOUSACTIVITYINSTANCE_NEXTA"   add constraint FK_PREVIOUSACTIVITYINSTANCE_2 foreign key ("ACTIVITYINSTANCE_OID_2") references "EXPEDIENTE"."ACTIVITYINSTANCE" ("OID");
alter table "EXPEDIENTE"."PREVIOUSACTIVITYINSTANCE_NEXTA"   add constraint FK_PREVIOUSACTIVITYINSTANCE_NE foreign key ("ACTIVITYINSTANCE_OID") references "EXPEDIENTE"."ACTIVITYINSTANCE" ("OID");
...
alter table "EXPEDIENTE"."PERSONAFISICA_PERSONAMORAL"   add constraint FK_PERSONAFISICA_PERSONAMORA_2 foreign key ("PERSONAFISICA_OID") references "EXPEDIENTE"."PERSONAFISICA" ("USER_OID");
alter table "EXPEDIENTE"."PERSONAFISICA_PERSONAMORAL"   add constraint FK_PERSONAFISICA_PERSONAMORA_3 foreign key ("PERSONAMORAL_OID") references "EXPEDIENTE"."PERSONAMORAL" ("USER_OID");


-- PersonaFisica_RepresentanteLegal [rel21]
alter table "EXPEDIENTE"."PERSONAFISICA"  add  "PERSONAMORAL_OID"  number(10,0);
alter table "EXPEDIENTE"."PERSONAFISICA"   add constraint FK_PERSONAFISICA_PERSONAMORAL foreign key ("PERSONAMORAL_OID") references "EXPEDIENTE"."PERSONAMORAL" ("USER_OID");
