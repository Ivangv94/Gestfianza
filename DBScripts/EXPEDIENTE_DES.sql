...
alter table "EXPEDIENTE"."SEQUENCEFLOW"   add constraint FK_SEQUENCEFLOW_ACTIVITYTYPE_2 foreign key ("ACTIVITYTYPE_OID") references "EXPEDIENTE"."ACTIVITYTYPE" ("OID");
...
alter table "EXPEDIENTE"."SEQUENCEFLOW"   add constraint FK_SEQUENCEFLOW_ACTIVITYTYPE foreign key ("ACTIVITYTYPE_OID_2") references "EXPEDIENTE"."ACTIVITYTYPE" ("OID");
...
alter table "EXPEDIENTE"."PERSONAFISICA_PERSONAMORAL"   add constraint FK_PERSONAFISICA_PERSONAMORA_3 foreign key ("PERSONAFISICA_OID") references "EXPEDIENTE"."PERSONAFISICA" ("USER_OID");
alter table "EXPEDIENTE"."PERSONAFISICA_PERSONAMORAL"   add constraint FK_PERSONAFISICA_PERSONAMORAL foreign key ("PERSONAMORAL_OID") references "EXPEDIENTE"."PERSONAMORAL" ("USER_OID");


-- PersonaFisica_RepresentanteLegal [rel21]
alter table "EXPEDIENTE"."PERSONAFISICA"  add  "PERSONAMORAL_OID"  number(10,0);
alter table "EXPEDIENTE"."PERSONAFISICA"   add constraint FK_PERSONAFISICA_PERSONAMORA_2 foreign key ("PERSONAMORAL_OID") references "EXPEDIENTE"."PERSONAMORAL" ("USER_OID");
