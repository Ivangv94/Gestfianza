...
// String digestion = '''ungWv48Bz+pBQUDeXa4iI7ADYaOWF3qctBD/YfIAFa0='''
...
try {   
    ...
    soapResponse = soapConnection.call(soapMessage, endpointURL);
        ...
        throw new RuntimeException("El servicio de estampa de tiempo de SE no responde", e.getCause());
        }
